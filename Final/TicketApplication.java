...
/**
   ...
   /*
      editTicket method retrives the theatre arrays and seat array. If there are seats that are selected
      then display and prompt user through the same process as add ticket. When a ticket is replaced
      it will replace in the seat array and the corresponding ticket that was replaced will be unreserved.
      
      @params theatre arrays, seat array
   */
   ...
   /**
     * Prompts the user for a ticket number and removes it from the reservedSeats array
